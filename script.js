document.addEventListener('DOMContentLoaded', function() {
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        fetch('https://formspree.io/f/xbdajwpb', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        .catch(error => {
            ...
            submitBtn.querySelector('span').textContent = 'Gagal!';
            submitIcon.classList.remove('fa-spinner', 'fa-spin');
    ...
    const projectsData = {
        ...
        'ecommerce': {
            title: 'Website E-commerce Perusahaan',
            category: 'Web • E-commerce',
            description: 'Platform e-commerce lengkap untuk perusahaan dengan sistem manajemen produk, latar belakang perusahaan, tentang perusahaan, dan dashboard perusahaan.',
            longDescription: 'Website e-commerce ini dikembangkan untuk membantu perusahaan dalam penjualan produk secara online. Sistem ini mencakup seluruh siklus penjualan dari browsing produk hingga pembayaran, dengan antarmuka admin yang komprehensif untuk mengelola inventory, pesanan, dan pelanggan.',
            features: [
                'Katalog produk dengan filter dan pencarian',
                'Multi-payment gateway (Bank Transfer, E-wallet)',
                'Dashboard admin untuk manajemen produk & pesanan',
                'Responsive design untuk semua device',
                'Optimasi SEO untuk produk'
            ],
            technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL', 'Bootstrap 5', 'REST API'],
            github: 'https://github.com/neveerlabs/e-commerce',
            demo: 'https://neveerlabs.github.io/e-commerce',
            image: 'images/bosscomp.png',
            date: 'Februari 2026'
        },
        'music-clock': {
            title: 'ChronoDeck',
            category: 'Web • Tool',
            description: 'Website yang menampilkan waktu secara real-time dengan berbagai tema tampilan dan pemutar musik yang dapat memutar file dari sistem operasi.',
            longDescription: 'Aplikasi web ini menggabungkan dua fungsi utama: jam digital yang menampilkan waktu secara real-time dengan animasi yang menarik, dan pemutar musik yang dapat mengelola playlist dari file lokal. Pengguna dapat mengubah tema tampilan, dan membuat playlist kustom mereka sendiri.',
            features: [
                'Jam digital real-time dengan berbagai format waktu',
                'Pemutar musik dengan support format MP3',
                'Upload dan manajemen musik dari file lokal',
                'System playlist dengan drag & drop',
                'Fitur alarm dengan notifikasi (Update kedepannya)',
                'Penyimpanan offline dengan LocalStorage',
                'Visualizer musik dengan Web Audio API'
            ],
            technologies: ['HTML5', 'CSS3', 'JavaScript', 'Web Audio API', 'File API', 'LocalStorage', 'Service Worker', 'Canvas'],
            github: 'https://github.com/neveerlabs/ChronoDeck',
            demo: 'https://neveerlabs.github.io/ChronoDeck/',
            image: 'images/ChronoDeck.png',
            date: 'Februari 2026'
        },
        'network-monitor': {
            title: 'Xcrack-ng',
            ...
            warning: [
                '<strong>PERINGATAN:</strong> Xcrack-ng adalah alat yang sangat berbahaya jika disalahgunakan.',
                '<strong>Xcrack-ng</strong> dapat lebih berbahaya jika seseorang menggunakan toolsnya, karena <strong>Xcrack-ng</strong> terhubung ke dalam server si pembuat, jadi berhati-hatilah untuk tidak menggunakannya.',
                'Alat ini hanya untuk tujuan edukasi dan testing jaringan yang anda miliki sendiri.',
                'Penggunaan terhadap jaringan orang lain tanpa izin adalah ilegal dan melanggar hukum.'
            ],
            features: [
                ...
                '<strong>Hanya untuk testing jaringan pribadi!</strong>'
            ],
    ...
    function initProjectDetails() {
        function showProjectDetail(projectId) {
            ...
            projectDetailContent.innerHTML = `
                ...
                ${project.warning ? `
                <div class="project-detail-section">
                    <h3><i class="fas fa-exclamation-triangle"></i> ${lang === 'id' ? 'Peringatan Penting' : 'Important Warning'}</h3>
                    <div class="warning-box">
                        ${project.warning.map(w => `<p class="warning-text">${w}</p>`).join('')}
                    </div>
                </div>
                ` : ''}
