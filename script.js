document.addEventListener('DOMContentLoaded', function() {
    ...
    const projectsData = {
        ...
        'network-monitor': {
            ...
            warning: ['<b>Xcrack-ng</b> dapat leih berbahaya jika seseorang menggunakan toolsnya, karena <b>Xcrack-ng</b> terhubung ke dalam server si pembuat, jadi berhati hatilah untuk tidak menggunakannya'],
